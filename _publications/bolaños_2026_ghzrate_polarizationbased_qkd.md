...
permalink: /publication/bolaños_2026_ghzrate_polarizationbased_qkd
excerpt: 'Quantum key distribution (QKD) leverages the principles of quantum mechanics to exchange a secret key between two parties. Despite its promising features, QKD also faces several practical challenges s...' if len(self.abstract) > 200 else self.abstract
date: 2026-01-01
venue: 'Optica Quantum'
paperurl: 'https://doi.org/10.1364/OPTICAQ.596140'
citation: 'Matías R. Bolaños, Edoardo Rossi, Federico Berra, Alberto De Toni, Ilektra Karakosta-Amarantidou,..., "GHz-rate polarization-based QKD system for fiber and satellite applications", Optica Quantum, vol. 4, pp. 389-396, (2026).'
---
...
**Authors:** Matías R. Bolaños, Edoardo Rossi, Federico Berra, Alberto De Toni, Ilektra Karakosta-Amarantidou, Daniel C. Lawo, Costantino Agnesi, **Marco Avesani**, Andrea Stanco, Francesco Vedovato, Paolo Villoresi, Giuseppe Vallone


[Journal](https://doi.org/10.1364/OPTICAQ.596140){: .btn .btn--info} [ArXiv](https://arxiv.org/abs/2602.08908){: .btn .btn--info}
